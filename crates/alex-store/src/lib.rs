...
fn trace_row_json(r: &rusqlite::Row) -> rusqlite::Result<Value> {
    ...
    Ok(json!({
        ...
        "original_account_id": r.get::<_, Option<String>>(28)?,
        "served_account_id": r.get::<_, Option<String>>(29)?,
        "upstream_format": r.get::<_, Option<String>>(30)?,
        "req_body_path": r.get::<_, Option<String>>(31)?,
        "upstream_req_body_path": r.get::<_, Option<String>>(32)?,
        "req_headers_json": r.get::<_, Option<String>>(33)?,
        "resp_headers_json": r.get::<_, Option<String>>(34)?,
        "account_id": r.get::<_, Option<String>>(35)?,
        "run_id": r.get::<_, Option<String>>(36)?,
        "tags_json": r.get::<_, Option<String>>(37)?,
        "client_ip": r.get::<_, Option<String>>(38)?,
        "key_fingerprint": r.get::<_, Option<String>>(39)?,
        "reasoning_effort": r.get::<_, Option<String>>(40)?,
        "thinking_budget": r.get::<_, Option<i64>>(41)?,
        "method": r.get::<_, Option<String>>(42)?,
        "path": r.get::<_, Option<String>>(43)?,
        "subscription_identity": r.get::<_, Option<String>>(44)?,
        "via_dario": r.get::<_, i64>(45)? != 0,
        "dario_generation": r.get::<_, Option<String>>(46)?,
