...
/// AlexCore continues to compile and test on Linux.
...
public enum ToolLink {
    public static func url(id: String, kind: String) -> URL? {
        var components = URLComponents(); components.scheme = "alex"; components.host = "tool"
        components.path = "/\(id)/\(kind)"; return components.url
    }
    public static func target(from url: URL) -> (id: String, kind: String)? {
        guard url.scheme == "alex", url.host == "tool" else { return nil }
...
public enum SessionKind {
    ...
    public static func badge(
        ...
        if let harness, harness.contains("alex-ping") { return "ping" }
...
extension NSAttributedString.Key {
    public static let transcriptBubbleKind = NSAttributedString.Key("alexBubbleKind")
    public static let transcriptBubbleGroup = NSAttributedString.Key("alexBubbleGroup")
    public static let transcriptTurnId = NSAttributedString.Key("alexTurnId")
}
#endif
