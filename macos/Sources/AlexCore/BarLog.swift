...
public enum BarLog {
    ...
    public static func stateDirectory(home: URL) -> URL {
        home.appendingPathComponent(".alex", isDirectory: true)
    }
    ...
    #if canImport(os)
    private static let subsystem = "com.alex.bar"
    ...
    private static let queue = DispatchQueue(label: "com.alex.bar.log")
